...
// Variable in which the main config will be cached
var config = null;
 ...
 */
module.exports.init = function(_config, callback) {
    callback = callback || function(err) {
        if (err) {
            log().error({'err': err}, 'Failed to initialize OAE');
        }
    };
 ...
 *
 * @return {Object}     config      The main configuration object. Note that a *reference* to the configuration is returned
 */
