 ...
 */
var registerActivityEntityAssociation = module.exports.registerActivityEntityAssociation = function(entityAssocation) {
    if (activityEntityAssociations[entityAssocation.entityType] && activityEntityAssociations[entityAssocation.entityType][entityAssocation.name]) {
        throw new Error(util.format('Attempted to register duplicate activity entity association of type "%s" and name "%s"', entityAssocation.entityType, entityAssocation.name));
    }

    activityEntityAssociations[entityAssocation.entityType] = activityEntityAssociations[entityAssocation.entityType] || {};
    activityEntityAssociations[entityAssocation.entityType][entityAssocation.name] = entityAssocation;
};
