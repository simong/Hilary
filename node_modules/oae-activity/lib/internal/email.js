 ...
 */
var collectMails = module.exports.collectMails = function(bucketNumber, emailPreference, day, hours, callback) {
    ...
    var bucketId = _createEmailBucketId(bucketNumber, emailPreference, day, hours);
...
var _createEmailBucketIdForUser = function(user) {
    ...
    if (emailPreference !== PrincipalsConstants.emailPreferences.IMMEDIATE) {
        ...
        console.log('%s %d %d(%s)', user.id, mailConfig[emailPreference].hour, offsetInHours, timezone)
