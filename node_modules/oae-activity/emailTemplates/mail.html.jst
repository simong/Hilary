                                            ...
                                            <% _.each(activity.allAnnotations, function(annotation) {
                                                ...
                                                <div class="activity-annotation-container" data-annotation-id="<%= annotation.id %>">
                                                    ...
                                                    <div class="activity-annotation">
                                                        ...
                                                        %>
                                                        <div class="activity-annotation-quote wrapped">&quot;<%= util.text.toHtml(annotation.quote) %>&quot;</div>
                                                        <div class="activity-annotation-text wrapped"><%= util.text.toHtml(annotation.text) %></div>
                                                    </div>
                                                </div>
                                            <% }); %>
