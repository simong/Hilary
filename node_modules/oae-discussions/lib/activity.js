 ...
 */
ActivityAPI.registerActivityEntityAssociation('discussion', 'self', 'The discussion itself', function(associationsCtx, entity, callback) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('discussion', 'members-by-role', 'Utility assocation to get all the members of the discussion by their role, not to be used directly', function(associationsCtx, entity, callback) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('discussion', 'members', 'The members of the discussion', function(associationsCtx, entity, callback) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('discussion', 'managers', 'The managers of the discussion', function(associationsCtx, entity, callback) {
    associationsCtx.get('members-by-role', function(err, membersByRole) {
        if (err) {
            return callback(err);
        }
 ...
 */
ActivityAPI.registerActivityEntityAssociation('discussion', 'message-contributors', 'The users who made a comment on the discussion recently', function(associationsCtx, entity, callback) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('discussion-message', 'self', 'The discussion item where this comment was made', function(associationsCtx, entity, callback) {
