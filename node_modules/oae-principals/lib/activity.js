...
ActivityAPI.registerActivityType(PrincipalsConstants.activity.ACTIVITY_GROUP_CREATE, {
    'description': {
        'msg': 'Generated when a user creates a new group',
        'entities': {
            'actor': 'user',
            'object': 'group'
        }
...
var _groupUpdateRouters = {
    'description': {
        'msg': 'Generated when a user updates a group\'s metadata',
        'entities': {
            'actor': 'user',
            'object': 'group'
        }
...
ActivityAPI.registerActivityType(PrincipalsConstants.activity.ACTIVITY_GROUP_JOIN, {
    'description': {
        'msg': 'Generated when one or more users join a group',
        'entities': {
            'actor': 'user',
            'object': 'group'
        }
...
ActivityAPI.registerActivityType(PrincipalsConstants.activity.ACTIVITY_GROUP_ADD_MEMBER, {
    'description': {
        'msg': 'Generated when a user and/or group is added as a member to a group',
        'entities': {
            'actor': 'user',
            'object': ['group', 'user'],
            'target': 'group'
...
ActivityAPI.registerActivityType(PrincipalsConstants.activity.ACTIVITY_GROUP_UPDATE_MEMBER_ROLE, {
    'description': {
        'msg': 'Generated when a user and/or group\'s role in a group is updated',
        'entities': {
            'actor': 'user',
            'object': ['group', 'user'],
            'target': 'group'
 ...
 */
ActivityAPI.registerActivityEntityAssociation('user', 'self', 'The user itself', function(associationsCtx, entity, callback) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('group', 'self', 'The group itself', function(associationsCtx, entity, callback) {
    return callback(null, [entity[ActivityConstants.properties.OAE_ID]]);
});
 ...
 */
ActivityAPI.registerActivityEntityAssociation('group', 'members-by-role', 'Utility assocation to get all the members of the group by their role, not to be used directly', function(associationsCtx, entity, callback) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('group', 'members', 'All the members of the group', function(associationsCtx, entity, callback) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('group', 'managers', 'All the managers of the group', function(associationsCtx, entity, callback) {
    associationsCtx.get('members-by-role', function(err, membersByRole) {
        if (err) {
            return callback(err);
        }
