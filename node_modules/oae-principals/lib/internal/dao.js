...
var setEmailAddress = module.exports.setEmailAddress = function(user, email, token, callback) {
    ...
    // Create the mapping
    queries.push(Cassandra.constructUpsertCQL('PrincipalsByEmail', 'email', email, {'principalId': user.id}));

    // Remove the old mapping, if any
    if (user.email && user.email !== email) {
        queries.push({'query': 'DELETE FROM "PrincipalsByEmail" WHERE "email" = ?', 'parameters': [user.email]});
    }
