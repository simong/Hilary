...
var ensureSchema = function(callback) {
    Cassandra.createColumnFamilies({
        ...
        'Pages': 'CREATE COLUMNFAMILY Pages (contentId text PRIMARY KEY, title text, body text, created text, createdBy text, lastModified text, lastModifiedBy text);',
        'PagesHierarchy': 'CREATE COLUMNFAMILY PagesHierarchy (contentId text PRIMARY KEY, hierarchy text);'
    }, callback);
};
