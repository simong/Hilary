 ...
 */
ActivityAPI.registerActivityEntityAssociation('content', 'self', 'The content item itself', function(associationsCtx, entity, callback) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('content', 'members-by-role', 'Utility assocation to get all the members of the content item by their role, not to be used directly', function(associationsCtx, entity, callback) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('content', 'members', 'The members of the content item', function(associationsCtx, entity, callback) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('content', 'managers', 'The managers of the content item', function(associationsCtx, entity, callback) {
    associationsCtx.get('members-by-role', function(err, membersByRole) {
        if (err) {
            return callback(err);
        }
 ...
 */
ActivityAPI.registerActivityEntityAssociation('content', 'message-contributors', 'The users who made a comment on this piece of content recently', function(associationsCtx, entity, callback) {
 ...
 */
ActivityAPI.registerActivityEntityAssociation('content-comment', 'self', 'The content item where this comment was made', function(associationsCtx, entity, callback) {
