...
var createLink = module.exports.createLink = function(ctx, displayName, description, visibility, link, additionalMembers, callback) {
    ...
    _createContent(ctx, 'link', displayName, description, visibility, additionalMembers, {'link': link}, {}, function(err, content, revision) {
        if (err) {
            return callback(err);
        }
...
var _createFile = function(ctx, displayName, description, visibility, additionalMembers, file, callback) {
    ...
    _createContent(ctx, 'file', displayName, description, visibility, additionalMembers, otherValues, otherValues, function(err, contentObj, revision) {
        if (err) {
            return callback(err);
        }
        ...
        getStorageBackend(ctx).store(ctx, file, options, function(err, uri) {
            ...
            // Update the revision with the URI.
            ContentDAO.Revisions.updateRevision(revision.revisionId, {'uri': uri}, function(err) {
                if (err) {
                    return callback(err);
                }
...
var createCollabDoc = module.exports.createCollabDoc = function(ctx, displayName, description, visibility, additionalMembers, callback) {
    ...
    _createContent(ctx, 'collabdoc', displayName, description, visibility, additionalMembers, {}, {'collabdocHtml': ''}, function(err, content, revision) {
        if (err) {
            return callback(err);
        }
 ...
 * @api private
 */
var _createContent = function(ctx, resourceSubType, displayName, description, visibility, additionalMembers, otherValues, revisionData, callback) {
    callback = callback || function() {};
    ...
    ContentDAO.Content.createContent(ctx.tenant().alias, ctx.user().id, resourceSubType, displayName, description, visibility, additionalMembers, otherValues, revisionData, function(err, contentObj, revision) {
        if (err) {
            return callback(err);
        }
