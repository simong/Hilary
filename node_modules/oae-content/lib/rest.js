 ...
 * Sakai documents
 */
// Modify the navigation structure of a Sakai Document
OAE.tenantServer.post('/api/content/:contentId/pages/structure', function(req, res) {
    ContentAPI.updateSakaiDocStructure(req.ctx, req.params.contentId, req.body.structure, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(201);
...
// Create a page inside of a Sakai Document
OAE.tenantServer.post('/api/content/:contentId/pages', function(req, res) {
    ContentAPI.createPage(req.ctx, req.params.contentId, req.body.title, req.body.description, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(201);
...
// Get a page inside of a Sakai Document
OAE.tenantServer.get('/api/content/:contentId/pages/:pageId', function(req, res) {
    ContentAPI.getPage(req.ctx, req.params.contentId, req.params.pageId, function(err, items) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(200, {'results': items});
...
// Edit a page inside of a Sakai Document
OAE.tenantServer.post('/api/content/:contentId/pages/:pageId', function(req, res) {
    ContentAPI.editPage(req.ctx, req.params.contentId, req.params.pageId, req.body, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(201);
...
// Delete a page inside of a Sakai Document
OAE.tenantServer.del('/api/content/:contentId/pages/:pageId', function(req, res) {
    ContentAPI.deletePage(req.ctx, req.params.contentId, req.params.pageId, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(200);
...
// Export a Sakai Document to PDF
OAE.tenantServer.get('/api/content/:contentId/export', function(req, res) {
    ContentAPI.exportSakaiDoc(req.ctx, req.params.contentId, function(err, items) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(200, {'results': items});
...
// Get the revisions on a Sakai Document
OAE.tenantServer.get('/api/content/:contentId/pages/:pageId/revisions', function(req, res) {
    ContentAPI.getSakaiDocRevisions(req.ctx, req.params.contentId, req.params.pageId, function(err, items) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(200, {'results': items});
...
OAE.tenantServer.post('/api/content/:contentId/pages/:pageId/revisions', function(req, res) {
    ContentAPI.restoreSakaiDocRevision(req.ctx, req.params.contentId, req.params.pageId, req.body, function(err) {
        if (err) {
            return res.send(err.code, err.msg);
        }
        res.send(201);
