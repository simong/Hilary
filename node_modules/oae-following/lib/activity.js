 ...
 */
ActivityAPI.registerActivityEntityAssociation('user', 'followers', 'Route the activity to all the followers of the user', function(associationsCtx, entity, callback) {
