...
describe('Annotations', function() {
    ...
    describe('Permissions', function() {
         ...
         */
        it('verify annotations resolve the permissions from the content item', function(callback) {
    ...
    describe('Activity', function() {
        ...
        var _assertActivityInStream = function(activityStream, expectInStream, actorId, content, annotation, activityType, verb, callback) {
            ...
            assert.strictEqual(activity.object[AnnotationConstants.activity.PROP_OAE_TEXT], annotation.text);
            assert.strictEqual(activity.object[AnnotationConstants.activity.PROP_OAE_QUOTE], annotation.quote);

            // Assert the necessary properties are present on the annotation activity entity
            activity.object['oae:annotationText'] = annotation.text;
            activity.object['oae:annotationQuote'] = annotation.quote;
            activity.object['oae:annotationPageNumber'] = annotation.pageNumber;
            return callback();
        };
            ...
            _setupFixture(function(content, simon, mrvisser, nico, bert, clay, stuart, stephen) {
                ...
                RestAPI.Annotations.createAnnotation(nico.restContext, content.id, content.latestRevisionId, 1, 'text', 'quote', ranges, function(err, annotation) {
                    ...
                    EmailTestsUtil.collectAndFetchAllEmails(function(messages) {
                        ...
                        // Assert the html contains the annotation
                        var email = messages[0]._message;
                        assert.ok(email.html);
                        assert.ok(email.html.indexOf(annotation.id) > 0);
                        return callback();
                    });
                });
            });
