 ...
 */
var createAnnotation = module.exports.createAnnotation = function(ctx, contentId, revisionId, pageNumber, text, quote, ranges, oaeId, callback) {
    ...
    ContentAPI.getFullContentProfile(ctx, contentId, function(err, content) {
        ...
        ContentDAO.Revisions.getRevision(revisionId, function(err, revision) {
            ...
            var annotation = new Annotation(id, contentId, revisionId, now, ctx.user().id, null, null, pageNumber, text, quote, ranges, oaeId);
