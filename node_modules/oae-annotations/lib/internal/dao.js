...
var _rowToAnnotation = function(row) {
    ...
    return new Annotation(hash.annotationId, hash.contentId, hash.revisionId, hash.created, hash.createdBy, hash.updated, hash.updatedBy, hash.pageNumber, hash.text, hash.quote, hash.ranges, hash.oaeId);
};
