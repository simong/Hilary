...
/*!
 * Get the annotations for a specific revision of a piece of content
 */
...
OAE.tenantRouter.on('post', '/api/content/:contentId/annotations/:revisionId', function(req, res) {
    AnnotationsAPI.createAnnotation(req.ctx, req.params.contentId, req.params.revisionId, req.body.pageNumber, req.body.text, req.body.quote, req.body.ranges, req.body.oaeId, function(err, annotation) {
        if (err) {
            return res.send(err.code, err.msg);
        }
