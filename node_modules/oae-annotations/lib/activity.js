...
var _transformPersistentAnnotation = function(ctx, entity) {
    ...
    opts.ext[AnnotationConstants.activity.PROP_OAE_TEXT] = annotation.text;
    opts.ext[AnnotationConstants.activity.PROP_OAE_QUOTE] = annotation.quote;
    opts.ext['fullannotation'] = annotation;

    if (annotation.updatedBy) {
        opts.updated = annotation.updated;
        opts.ext[AnnotationConstants.activity.PROP_OAE_UPDATED_BY] = PrincipalsUtil.transformPersistentUserActivityEntity(ctx, annotation.updatedBy.id, annotation.updatedBy);
    }
